    ...
    <div class="row" style="padding-top: 50px">
        <div class="col-lg-12 col-xs-12">
            <div class="logo animated fadeInUp">
                Clay Blog<small style="font-size: 14px;">安装向导</small>
            </div>
            <#if isInstall==false>
                ...
                <div class="box box-solid animated" id="installFirst">
                    <div class="box-body" style="padding: 30px;">
                        <div class="form-group animated fadeInUp" style="animation-delay: 0.1s">
                            <label for="blogLocale" class="col-sm-4 control-label">系统语言:</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group animated fadeInUp" style="animation-delay: 0.2s">
                            <label for="blogTitle" class="col-sm-4 control-label">博客标题:</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group animated fadeInUp" style="animation-delay: 0.3s">
                            <label for="blogUrl" class="col-sm-4 control-label">博客地址:</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group animated fadeInUp" style="animation-delay: 0.6s">
                            <label for="userDisplayName" class="col-sm-4 control-label">显示昵称:</label>
                            <div class="col-sm-8">
                    ...
                    <div class="box-footer" style="padding-right: 30px;">
                        <button type="submit" class="btn btn-primary btn-sm btn-flat pull-right animated fadeInUp" style="animation-delay: 1s">安装Halo</button>
                    </div>
                </div>
